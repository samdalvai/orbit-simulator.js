...
export const generatePackedBarnesHutGravitationalForce = generateBarnesHutGravitationalForce;
export const applyPackedBarnesHutGravitationalForces = applyBarnesHutGravitationalForces;

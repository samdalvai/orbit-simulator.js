...
const ASTEROID_BELT_OBJECTS = 3000;
...
// TODO: render styles should be based on real ids, not the ones generated by body Class
export function createSolarSystemPacked(engine: Engine): SolarSystem {
    const bodies: Body[] = [];
